...
import Shopfooter2 from "./shopfooter2";

const products = [
	{ id: 1, image: "/images/16.avif", name: "Mens's Canvas Pipers", description: "Natural White / Hanami Night", price: "$90" },
	{ id: 2, image: "/images/16.avif", name: "Men's Canvas Pipers", description: "Natural Black", price: "$90" },
	{ id: 3, image: "/images/12w.avif", name: "Men's Lounger Lift", description: "Weathered Grey", price: "$105" },
	{ id: 4, image: "/images/13.avif", name: "Men's Tree Runner Go", description: "Hanami Night", price: "$120" },
	{ id: 5, image: "/images/14.avif", name: "Men's Breeze Runners", description: "Blue Shade", price: "$98" },
	{ id: 6, image: "/images/15.avif", name: "Men's Casual Sneakers", description: "Storm Grey", price: "$115" },
];
